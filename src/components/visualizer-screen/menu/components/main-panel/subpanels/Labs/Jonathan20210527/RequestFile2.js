...
export default function GeneratedData(props) {
    ...
    return (
        <div>
            ...
            <a href="https://github.com/jpiland16/hmv_test/blob/master/src/components/visualizer-screen/menu/components/main-panel/subpanels/Labs/Jonathan20210527/RequestFile2.js" target="_blank" rel="noreferrer">View relevant code</a>
        </div>
    )
}