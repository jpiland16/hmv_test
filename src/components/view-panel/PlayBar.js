...
export default function PlayBar(props) {
    ...
    return (
        <div className="playBar" style={{ 
            // left: props.menuIsOpen && props.getWindowDimensions()[0] > 768 ? "40vw" : "0px", //may need to change back for single file mode
            width: '100%'//width: props.menuIsOpen && props.getWindowDimensions()[0] > 768 ? "60%" : "100%" 
            }}>
