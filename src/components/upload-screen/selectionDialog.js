...
export default function DialogSelect(props) {
  ...
  const sliders = () => props.boneName.map((boneName)=>(props.visualizer.getSliders(props.quaternions, props.setQuaternions).filter((element) => element.props.quaternionTarget.shortName === boneName))[0])
  ...
  return (
    <div>
      ...
      <TextField 
            ...
            //value={props.localTransformQuaternion[0] ? quaternionToString(props.localTransformQuaternion[0]) : "click here to select"}
